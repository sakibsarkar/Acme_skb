...
const Ending = () => {
  return (
    <section className="flex border-t-[1px] border-primaryBorder md:flex-row flex-col">
      <div className="flex-1 py-12 pl-[48px] pr-[30px]">
        <h1 className="text-[24px] max-w-[499px] text-[#666] tracking-[-0.96px] leading-[32px]">
      ...
      <div className="max-w-[358px] p-12 border-l border-primaryBorder">
        <h1 className="text-[#666] mb-6 text-[16px] max-w-[496px] tracking-[-0.96px] leading-[24px]">
